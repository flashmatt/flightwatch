<template>
  <transition :name="isDesktop ? 'slide-fade' : 'slide-fade-bottom'">
    <aside
      ...
      class="absolute bottom-0 md:left-6 md:bottom-6 lg:top-20 flex flex-col w-full md:w-96 bg-neutral-200 rounded-t-2xl md:rounded-b-2xl overflow-hidden shadow-2xl transition-all duration-500 ease-in-out"
      :class="{
...
.expand-enter-to,
.expand-leave-from {
  max-height: 9999px; /* A value larger than your maximum content height */
}
</style>
